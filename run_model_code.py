...
joblib.dump(strong_model, os.path.join(BASE_DIR, "model.pkl"))

feature_names = num_cols + list(
    strong_model.named_steps['prep'].transformers_[1][1].named_steps['onehot'].get_feature_names_out(cat_cols)
)
...
print("Part 3 ML training completed. Outputs saved.")
